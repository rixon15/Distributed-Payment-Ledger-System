package com.openfashion.ledgerservice.chaos.kafka;
...
class KafkaChaosTest {
    ...
    @Test
    void kafkaDown_eventIsNotProcessedUntilBrokerRecovers_thenPersistsExactlyOnce() throws Exception {
    ...
    @Test
    void kafkaLatency_delaysIngressButDoesNotCreateDuplicates_andEventuallyPersists() throws Exception {
        Seed seed = seedTransferAccounts();
        ...
        kafkaProxy.toxics().latency("kafka-latency", ToxicDirection.DOWNSTREAM, 2_000);
